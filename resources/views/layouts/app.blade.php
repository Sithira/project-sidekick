        ...
        <li class="nav-item">
            ...
            <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="login.html">My Experience</a>
                    <a class="collapse-item" href="register.html">My Qualifications</a>
                    <a class="collapse-item" href="register.html">My Skills</a>
                </div>
            </div>
        </li>
