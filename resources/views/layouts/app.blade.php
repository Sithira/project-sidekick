...
<head>
    ...
    <link href="{{ asset('css/CodeSquad.css') }}" rel="stylesheet">
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{!! url('/') !!}">
            ...
            <div class="sidebar-brand-text mx-3">CodeSquad
                <small>beta</small>
            </div>
        </a>
    ...
    @if(auth()->check())
        <!-- Nav Item - Dashboard -->
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{!! url('/profile/questions') !!}">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Manage my profile</h6>
                        <a class="collapse-item" href="{!! route('experience.index') !!}">My Experience</a>
                        <a class="collapse-item" href="{!! route('qualifications.index') !!}">My Qualifications</a>
                        <a class="collapse-item" href="{!! route('skills.index') !!}">My Skills</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#projects"
                   aria-expanded="true" aria-controls="projects">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>Projects and Proposals</span>
                </a>
                <div id="projects" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{!! url('/profile/proposals') !!}">My Proposals</a>
                    </div>
                </div>
            </li>
    ...
    <!-- Heading -->
        ...
        <!-- Nav Item - Pages Collapse Menu -->
        <li class="nav-item">
            <a class="nav-link collapsed" href="{!! url('/forum') !!}">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="{!! url('/people') !!}">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <div class="dropdown-item">
                                    {!! Form::open(['method' => 'post', 'url' => '/logout']) !!}
                                        {!! Form::submit('Logout', ['class' => 'btn btn-sm', 'style' => 'background-color:transparent']) !!}
                                    {!! Form::close() !!}
                                </div>
                            </div>
                        </li>
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; CodeSquad 2019</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
